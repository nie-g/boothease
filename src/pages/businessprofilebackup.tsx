...
const BusinessProfilePage: React.FC = () => {
  ...
  ) as BusinessProfile | null | undefined;
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 md:p-8 overflow-auto">
          <motion.div
            ...
            className="w-full max-w-7xl mx-auto space-y-6 px-4 md:px-0"
          >
            <h1 className="text-2xl font-bold mb-6 text-gray-600">Business Profile</h1>

            {/* Profile Info */}
            <div className="p-4 bg-white rounded-2xl shadow-md border border-gray-200 flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
              <div>
