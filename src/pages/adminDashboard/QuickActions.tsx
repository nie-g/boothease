...
const actions = [
  {
    label: "Manage Business Profiles",
    description: "View and manage all user's business profile and upload business documents.",
    icon: <PlusCircle className="h-5 w-5 text-orange-700" />,
    path: "/renter/businessprofile",
  },
  {
    label: "Manage Users",
  ...
  },
  {
    ...
    description: "View all booths and manage events",
